 ...
 */
USTRUCT()
struct WARFORAPPLE_API FMassWaitTaskInstanceData
{
	GENERATED_BODY()
 ...
 * 
 */
USTRUCT(meta = (DisplayName = "WFAMassWaitTask"))
struct WARFORAPPLE_API FMassWaitTask : public FMassStateTreeTaskBase
{
	GENERATED_BODY()
